...
@section('content')
    ...
    <div class="container-registro mt-5">
        ...
        <form method="post" action="{{ route('estudianteEdit', $estudiante->id) }}">
            @method('PUT')
            @csrf

            <div class="form-group form-registro">
                <label>Nombre Estudiante</label>
                <input value="{{ $estudiante->nombreEstudiante }}" type="text"
                    class="form-control  $errors->has('nombreEstudiante') ? 'error' : '' " name="nombreEstudiante"
                    id="nombreEstudiante">
            ...
            <div class="form-group form-registro">
                ...
                <input value="{{ $estudiante->apellidosEstudiante }}" type="text"
                    class="form-control  $errors->has('apellidosEstudiante') ? 'error' : '' " name="apellidosEstudiante"
            ...
            <div class="form-group form-registro">
                ...
                <input value="{{ $estudiante->matricula }}" type="text"
                    class="form-control  $errors->has('matricula') ? 'error' : '' " name="matricula" id="matricula">
            ...
            <div class="form-group form-registro">
                ...
                <input value="{{ $estudiante->correoInstitucional }}" type="email"
                    class="form-control  $errors->has('correoInstitucional') ? 'error' : '' " name="correoInstitucional"
            ...
            <div class="form-group form-registro">
                ...
                <select class="form-control  $errors->has('licenciatura') ? 'error' : '' " name="licenciatura"
                    id="licenciatura">
            ...
            <div class="form-group form-registro">
                ...
                <select class="form-control  $errors->has('areaAcademmica') ? 'error' : '' " name="areaAcademica"
                    id="areaAcademica">
