...
@section('content')
    ...
    <div>
        <p class="titulo">SEF > Lista de estudiantes > Registrar datos de estudiante</p>
    </div>
    ...
    <div class="container-registro mt-5">
        ...
        <form action="" method="post" action="action('EstudianteController@registrarEstudiante') ">
            ...
            <div class="form-group form-registro">
                ...
                <input type="text" class="form-control  $errors->has('nombreEstudiante') ? 'error' : '' "
                    name="nombreEstudiante" id="nombreEstudiante">
            ...
            <div class="form-group form-registro">
                ...
                <input type="text" class="form-control  $errors->has('apellidosEstudiante') ? 'error' : '' "
                    name="apellidosEstudiante" id="apellidosEstudiante">
            ...
            <div class="form-group form-registro">
                ...
                <input type="text" class="form-control  $errors->has('matricula') ? 'error' : '' " name="matricula"
                    id="matricula">
            ...
            <div class="form-group form-registro">
                ...
                <input type="email" class="form-control  $errors->has('correoInstitucional') ? 'error' : '' "
                    name="correoInstitucional" id="correoInstitucional">
